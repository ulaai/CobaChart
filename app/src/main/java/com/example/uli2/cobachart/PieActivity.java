...
public class PieActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PagerAdapter pagerAdapter = new PagerAdapter(getSupportFragmentManager(), PieActivity.this);
    ...
    class PagerAdapter extends FragmentPagerAdapter {
        ...
        public View getTabView(int position){
            View tab = LayoutInflater.from(PieActivity.this).inflate(R.layout.custom_tab, null);
